...
public interface BacklogService {
    boolean add(BacklogDTO backlogDTO) throws ProjectNotFoundException;
    boolean delete(Long id);
    boolean update(Long id, BacklogDTO backlogDTO) throws BacklogNotFoundException, ProjectNotFoundException, UnvalidProgressValueException;
